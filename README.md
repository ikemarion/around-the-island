...
Download [ATI v0.46 for Windows](https://github.com/ikemarion/around-the-island/raw/refs/heads/main/releases/ATI-v0.46-Windows.zip), extract it, and run the included ATI executable. Protocol 14: everyone must update. New: remodeled cardboard boxes, sculpted retro car, piped sofa cushions, and rounded CRT television/console, checked with in-engine renders. Charged chaser boost remains F / left bumper. Direct Internet joining requires a reachable public IP and UDP forwarding; normal Join still uses Playit. Joining automatically shares unsent ATI diagnostics with the configured host. See [NETWORK-RELIABILITY.md](NETWORK-RELIABILITY.md).
