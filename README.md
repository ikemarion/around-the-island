...
Download [ATI v0.50 for Windows](https://github.com/ikemarion/around-the-island/raw/refs/heads/main/releases/ATI-v0.50-Windows.zip), extract it, and run the included ATI executable. Protocol 16. New in v0.50: Sockling puppet players with raised eyes, a recessed animated mouth, fleece shading, striped knitted cuffs, coral feet, and floppy movement in four player colors. The refreshed kitchen remains. Chase lanes, colliders, score display, and network rules are unchanged. The 2× Speed sneaker pickup doubles running/crouching speed for five seconds, activated with Q / right bumper. No stacking with the charged chaser boost. Charged chaser boost remains F / left bumper. Direct Internet joining requires a reachable public IP and UDP forwarding; normal Join still uses Playit. Joining automatically shares unsent ATI diagnostics with the configured host. See [NETWORK-RELIABILITY.md](NETWORK-RELIABILITY.md).
