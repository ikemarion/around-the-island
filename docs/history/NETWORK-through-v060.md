# Historical network reliability notes — through v0.60

Archived on 2026-09-22. Version numbers and instructions below describe historical tests, not the current release. Use the repository-root ONLINE-PLAY.md and NETWORK-RELIABILITY.md for current procedures.
